...
(1, '2020-01-13 04:05:27', '1', 1, 1, '2020-01-13 00:00:00', '2020-01-13 00:00:00'),
(2, '2020-01-13 10:18:04', '1', 2, 1, '2020-01-13 00:00:00', '2020-01-13 00:00:00');
...
CREATE TABLE `events` (
  ...
  `feature_image` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `day_cares_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `members` (`id`, `parents_id`, `registrations_id`, `member_types_id`, `day_cares_id`, `child_name`, `child_dob`, `gender`, `child_age`, `child_weight`, `child_height`, `birth_mark`, `birth_certificate_no`, `describe_food`, `describe_health_problem`, `child_vaccination`, `created`, `updated`) VALUES
(1, 27, 2, 0, 1, 'হুমাইরা মোস্তাফা', '2019-10-23', 'Female', '১৪ মাস', '৫ কেজি', '২ ফুট', 'নাই', 2147483647, 'নাই', 'নাই', 'No', '2020-01-15 18:14:20', NULL);
...
CREATE TABLE `settings` (
  `id` int(11) NOT NULL,
  `day_cares_id` int(11) NOT NULL,
  `facebook_acc` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `twitter_acc` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `fingerprint_device_id` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `created` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `parents`
  ADD PRIMARY KEY (`id`,`day_cares_id`,`members_id`),
  ADD KEY `fk_registrations_day_cares1_idx` (`day_cares_id`),
  ADD KEY `fk_parents_members1_idx` (`members_id`);
...
ALTER TABLE `settings`
  ADD PRIMARY KEY (`id`,`day_cares_id`),
  ADD KEY `fk_settings_day_cares1_idx` (`day_cares_id`);
...
ALTER TABLE `sliders`
  ADD PRIMARY KEY (`id`,`day_cares_id`),
  ADD KEY `fk_sliders_day_cares1_idx` (`day_cares_id`);
