      ...
      <div class="col-md-12">
         <div class="box box-primary">
            <div class="box-header with-border">
               ...
               <a href="<?=base_url('adminpanel/gallery/add')?>" class="btn btn-info btn-xs pull-right"> Add Gallery</a>          
            </div>        
                           ...
                           <td> 
                              <div class="btn-group">
                                 ...
                                 <ul class="dropdown-menu" role="menu">
                                    <!-- <li><a href="<?=base_url('adminpanel/gallery/edit/'.$row->id)?>">Edit</a></li> -->
                                    <li><a href="<?=base_url('adminpanel/gallery/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this data?');">Delete</a></li>
                                 </ul>
                              </div>
                           </td>
                        </tr>
