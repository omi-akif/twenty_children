      ...
      <div class="col-md-12">
         <div class="box box-primary">
            <div class="box-header with-border">
               ...
               <a href="<?=base_url('adminpanel/day_care_others/add')?>" class="btn btn-info btn-xs pull-right" style="margin-left: 15px;"> Add New</a>
            </div>        
                  ...
                  <tbody>
                     ...
                     $sl=0;
                        ...
                        <tr>
                           ...
                           <a href="<?=base_url('adminpanel/day_care_others/edit/'.$row->id)?>" class="btn btn-info btn-xs">Edit</a>
                           <?php /*
                              <div class="btn-group">
