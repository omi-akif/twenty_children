                ...
                <td> 
                  <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <!-- <li><a href="<?=base_url('adminpanel/slider/details/'.$row->id)?>">Details</a></li> -->
                        <li><a href="<?=base_url('adminpanel/slider/edit/'.$row->id)?>">Edit</a></li>
                        <li><a href="<?=base_url('adminpanel/slider/delete/'.$row->id)?>" onclick="return confirm('Are you sure you want to delete this Slider?');">Delete</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
