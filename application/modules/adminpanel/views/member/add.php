   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box box-primary">
            ...
            echo form_open_multipart("adminpanel/member/add", $attributes);
            ?>
            <div class="box-body">
               ...
               <div class="row">
                  <div class="col-md-7">
                     ...
                     <div class="row row-form">
                        ...
                        <h4 style="margin-left: 15px; font-weight: bold;">Permanent Address</h4>
                        <div class="col-md-6">
                           <div class="form-group">
               ...
               <div class="col-md-5">
                  <fieldset class="col-md-12">      
                     ...
                     <div class="row row-form">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label>Service ID / Email <span class='required'>*</span></label>
      ...
      $("#jsvalidation").validate({
         rules: {
            ...
            member_no: {
               ...
               minlength: 4,
               remote: {
                  url: hostname +"adminpanel/ajax_exists_member_no/",
                  type: "post",
                  data: {
                     inputData: function() {
